...
__used __section(__versions) = {
	...
	{ 0x19dc34ba, "ahci_pmp_retry_srst_ops" },
	{ 0x5d19df1a, "ahci_ops" },
	{ 0xaf1e3085, "param_ops_int" },
	{ 0x448125e8, "pci_unregister_driver" },
	{ 0x79f56529, "__pci_register_driver" },
	{ 0xe771636, "ahci_dev_classify" },
	...
	{ 0x41721b95, "ahci_kick_engine" },
	{ 0xbe69e5f4, "ata_wait_after_reset" },
	{ 0x2b6825f, "ahci_check_ready" },
	{ 0x15ba50a6, "jiffies" },
	...
	{ 0x739ca362, "ata_pci_shutdown_one" },
	{ 0x8a1e87b4, "_dev_err" },
...
MODULE_INFO(srcversion, "3F4E4F52FD2D5F8BBD5F972");
